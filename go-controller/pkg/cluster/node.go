...
func (cluster *OvnClusterController) StartClusterNode(name string) error {
	...
	cluster.watchNamespaceUpdate(node, subnet.String())
	return err
}
...
func (cluster *OvnClusterController) watchNamespaceUpdate(node *kapi.Node,
	subnet string) {
	cluster.watchFactory.AddNamespaceHandler(cache.ResourceEventHandlerFuncs{
		UpdateFunc: func(old, newer interface{}) {
			...
			if newMasterIP != "" && newMasterIP != oldMasterIP {
